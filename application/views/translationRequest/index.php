<div class="container">
        ...
        <div class="col-md-6">
            <div class="row">
                <div class="col-md-12">
                    <!--First column-->
                    <div class="md-form">
                        <input type="text" id="title" class="form-control" length="100">
                        <label for="form41" class="">Title</label>
                    </div>
                    <div class="md-form">
                        <textarea type="text" id="content" class="md-textarea"></textarea>
                        <label for="form76">Translation Content</label>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="md-form form-sm">
                    <select class="mdb-select" id="textLang">
                    <option value="" disabled selected>Text Language</option>
    ...
    <script type="text/javascript" src="<?php echo base_url("public/js/translation.js"); ?>"></script>